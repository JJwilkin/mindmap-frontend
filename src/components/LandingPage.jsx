  ...
  return (
    <div className="landing-page">
      <div className="landing-content">
        <h1 className="landing-title">Learn anything.</h1>
        <p className="landing-subtitle">
          Learn how everything is connected and see the big picture.
        </p>
      ...
      <div className="landing-image-container" onClick={handleEnter}>
        <img src={landingImage} alt="Knowledge Graph" className="landing-image" />
      </div>
    </div>
  );
};
